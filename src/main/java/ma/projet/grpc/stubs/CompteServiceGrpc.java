...
public final class CompteServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.projet.grpc.stubs.GetAllCmptesRequest,
      ma.projet.grpc.stubs.GetAllCmptesResponse> getAllComptesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AllComptes",
      requestType = ma.projet.grpc.stubs.GetAllCmptesRequest.class,
      responseType = ma.projet.grpc.stubs.GetAllCmptesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.projet.grpc.stubs.GetAllCmptesRequest,
      ma.projet.grpc.stubs.GetAllCmptesResponse> getAllComptesMethod() {
    io.grpc.MethodDescriptor<ma.projet.grpc.stubs.GetAllCmptesRequest, ma.projet.grpc.stubs.GetAllCmptesResponse> getAllComptesMethod;
      ...
      synchronized (CompteServiceGrpc.class) {
        if ((getAllComptesMethod = CompteServiceGrpc.getAllComptesMethod) == null) {
          CompteServiceGrpc.getAllComptesMethod = getAllComptesMethod = 
              io.grpc.MethodDescriptor.<ma.projet.grpc.stubs.GetAllCmptesRequest, ma.projet.grpc.stubs.GetAllCmptesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CompteService", "AllComptes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.projet.grpc.stubs.GetAllCmptesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.projet.grpc.stubs.GetAllCmptesResponse.getDefaultInstance()))
  ...
  public static abstract class CompteServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void allComptes(ma.projet.grpc.stubs.GetAllCmptesRequest request,
        io.grpc.stub.StreamObserver<ma.projet.grpc.stubs.GetAllCmptesResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.projet.grpc.stubs.GetAllCmptesRequest,
                ma.projet.grpc.stubs.GetAllCmptesResponse>(
  ...
  public static final class CompteServiceBlockingStub extends io.grpc.stub.AbstractStub<CompteServiceBlockingStub> {
     ...
     * </pre>
     */
    public ma.projet.grpc.stubs.GetAllCmptesResponse allComptes(ma.projet.grpc.stubs.GetAllCmptesRequest request) {
  ...
  public static final class CompteServiceFutureStub extends io.grpc.stub.AbstractStub<CompteServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.projet.grpc.stubs.GetAllCmptesResponse> allComptes(
        ma.projet.grpc.stubs.GetAllCmptesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ALL_COMPTES:
          serviceImpl.allComptes((ma.projet.grpc.stubs.GetAllCmptesRequest) request,
              (io.grpc.stub.StreamObserver<ma.projet.grpc.stubs.GetAllCmptesResponse>) responseObserver);
          break;
